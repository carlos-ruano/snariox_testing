...
public class FormularioEmailInvalido {
	...
	public void la_pagina_de_contacto_tc43() {
	...
	public void el_usuario_rellena_el_campo_email_con_un_formato_invalido_tc43() {
		driver.findElement(By.id("nombre")).sendKeys("Pedro");
	    driver.findElement(By.id("email")).sendKeys("correo2mail.com");
	...
	public void el_formulario_no_se_envia_correctamente_tc43() {
