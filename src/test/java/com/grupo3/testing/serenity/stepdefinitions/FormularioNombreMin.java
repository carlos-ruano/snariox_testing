...
public class FormularioNombreMin {
	...
	public void la_pagina_de_contacto_tc36() {
	...
	public void el_usuario_rellena_el_campo_nombre_que_no_supera_el_numero_minimo_de_caracteres_permitidos_tc36() {
		driver.findElement(By.id("nombre")).sendKeys("Pe");
	...
	public void el_formulario_no_se_envia_correctamente_tc36() {
