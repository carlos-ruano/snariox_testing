...
public class FormularioTelefonoInvalido {
	...
	public void la_pagina_de_contacto_tc48() {
	...
	public void el_usuario_rellena_el_campo_telefono_con_un_formato_invalido_tc48() {
		driver.findElement(By.id("nombre")).sendKeys("Pedro");
	    driver.findElement(By.id("email")).sendKeys("correo@mail.com");
	    driver.findElement(By.id("telefono")).sendKeys("123asd444");
	...
	public void el_formulario_no_se_envia_correctamente_tc48() {
